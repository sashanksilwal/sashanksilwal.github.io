This is the fourth time I've written about Claude Code, which probably tells you something. I started with [the basics](/blog/claude-code-basics.html), then wrote up [the workflows that actually compound](/blog/claude-code-intermediate.html), then went through [the 15 hidden features from Boris Cherny's thread](/blog/claude-code-hidden-features.html). Those last ones I learned from someone else. The ones in this post I found the slow way, by using the tool every day and bumping into things.
