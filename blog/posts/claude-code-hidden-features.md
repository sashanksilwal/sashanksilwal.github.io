[Boris Cherny](https://borischerny.com/about/), who is a software engineer at Anthropic, posted a thread on X last week with 15 features that most people don't know about. I've been using Claude Code daily for months now (wrote about the [basics](/blog/claude-code-basics.html) and [intermediate workflows](/blog/claude-code-intermediate.html) earlier), and half of these were new to me. Some of them genuinely change how you'd use the tool.
